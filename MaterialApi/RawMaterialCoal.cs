...
[Table("RAWMATERIALCOAL")]
public class RawMaterialCoal
{
    [Key]
    [Column("COALID")]
    ...
    // Numeric Fields
    [Column("QTYMT")] public double? QtyMt { get; set; } // React key must be qtyMt
    [Column("MINUS3MM")] public double? Minus3mm { get; set; } // React key must be minus3mm
    ...
    [NotMapped] public string? InspectionLot { get; set; }
